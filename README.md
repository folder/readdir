...
**TLDR**: `@folder/readdir` is tied for the fasted readdir lib in Node.js, with a clean and easy-to-use API.

* It's [blazing fast](#benchmarks)
* It has a simple, straightforward API and [options](#options) for advanced use cases.
* Well-tested and handled a number of common cases with symbolic links and "realpaths" that aren't often addressed by readdir libs.
